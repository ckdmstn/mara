...
function scene:create( event )
	...
	local background = display.newImageRect( "endingImage/main_BG.png", display.contentWidth, display.contentHeight )
	background.alpha = 1
   	background.x = display.contentWidth/2
   	background.y = display.contentHeight/2

   	local e = display.newImageRect("endingImage/end.png", 436, 160)
   	e.x, e.y = 1090, 610

   	local truck = display.newImageRect("endingImage/truck.png", 427, 251)
   	truck.alpha = 1
	...
	local contract_BG = display.newImageRect("endingImage/contract_BG.png", display.contentWidth, display.contentHeight)
   	contract_BG.x = display.contentWidth/2
   	contract_BG.y = display.contentHeight/2
   	contract_BG.alpha = 1

   	local building = {}
   	building[1] = display.newImageRect("endingImage/building1.png", 428- 170, 441-170)
   	building[1].name = 1
   	building[1].x, building[1].y = display.contentWidth/2 - 420 , display.contentHeight/2 +30
   	building[2] = display.newImageRect("endingImage/building2.png", 428- 170, 441-170)
   	building[2].x, building[2].y = display.contentWidth/2 - 410 + 400 + 10 , display.contentHeight/2 + 30
   	building[2].name = 2
   	building[3] = display.newImageRect("endingImage/building3.png", 428- 170, 441-170)
   	building[3].x, building[3].y = display.contentWidth/2 - 410 + 400 * 2 + 20, display.contentHeight/2 + 30
   	building[3].name = 3
   	
   	--간판
   	local board = display.newImageRect("endingImage/board.png", 385-100, 231-100)
   	board.alpha = 0
   	...
   	--게임 제목
   	local title = display.newImageRect("endingImage/title.png", display.contentWidth, display.contentHeight)
   	title.alpha = 0
   	title.x = display.contentWidth/2
   	title.y = display.contentHeight/2

   	local contract = display.newImageRect("endingImage/contract.png", 271, 204)
   	contract.alpha = 0
